CREATE PROCEDURE [test].[usp_SSIS_StagingTarget_Merge deletes correctly]
AS
BEGIN
    IF @@TRANCOUNT > 0
        BEGIN   
            ...
            -- Target will contain rows that the stagging table does not, these rows should be deleted
