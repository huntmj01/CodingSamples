CREATE PROCEDURE [test].[usp_SSIS_StagingTarget_Merge updates correctly]
AS
BEGIN
    IF @@TRANCOUNT > 0
        BEGIN   
            ...
            --Assemble
            INSERT INTO [test].[TargetTable]  ( [ColumnPK], [Column1], [Column2], [Column3] )
            ...
            VALUES                                    ( 'CLPK1',    '1111111', '2222222', '3333333' )
            ,                                         ( 'CLPK2',    'XXXXXXX', 'YYYYYYY', 'ZZZZZZZ' );
            
            -- Target will contain a row that is out of sync from the stagging table, this row should be updated
