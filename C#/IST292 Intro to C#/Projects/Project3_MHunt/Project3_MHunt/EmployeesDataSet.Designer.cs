...
namespace Project3_MHunt {
    ...
    public partial class EmployeesDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Name, string Position, double HourlyRate, System.DateTime HireDate) {
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public double HourlyRate {
                get {
                    return ((double)(this[this.tableEmployees.HourlyRateColumn]));
                }
                set {
...
namespace Project3_MHunt.EmployeesDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([Name], [Position], [HourlyRate], [HireDate]) VALU" +
                "ES (@Name, @Position, @HourlyRate, @HireDate);\r\nSELECT Id, Name, Position, Hourl" +
                "yRate, HireDate FROM Employees WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE       Employees\r\nSET                Name = @Name, Position = @Position, Ho" +
                "urlyRate = @HourlyRate\r\nWHERE        (Id = @Id);  \r\nSELECT Id, Name, Position, H" +
                "ourlyRate, HireDate FROM Employees WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Position", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Position", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@HourlyRate", global::System.Data.SqlDbType.Float, 8, global::System.Data.ParameterDirection.Input, 0, 0, "HourlyRate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Project3_MHunt.Properties.Settings.Default.CSharpIndustriesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Position, HourlyRate, HireDate FROM dbo.Employees";
        ...
        public virtual int Insert(string Name, string Position, double HourlyRate, System.DateTime HireDate) {
            if ((Name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((double)(HourlyRate));
        ...
        public virtual int Update(string Name, string Position, double HourlyRate, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((double)(HourlyRate));
